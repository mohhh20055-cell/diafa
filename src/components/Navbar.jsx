      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8 py-3">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          ...
          {isAuthenticated && (
            <Link
              to="/notifications"
              className="relative flex items-center justify-center w-9 h-9 rounded-full border border-[#152A54]/15 text-[#152A54] hover:bg-[#152A54]/5 hover:border-[#CB9A56] transition"
