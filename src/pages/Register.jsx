    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0E1E3D] relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-xl w-full relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-neutral-100">
          {/* Selector Tabs: Client vs Établissement / Propriétaire */}
          <div className="mb-8 grid grid-cols-2 gap-2 p-1.5 bg-neutral-100 rounded-xl border border-neutral-200">
            <button
              type="button"
              onClick={() => setAccountRole('client')}
              className={`py-2.5 px-4 rounded-lg text-xs sm:text-sm font-bold transition-all flex items-center justify-center gap-2 ${
                accountRole === 'client'
                  ? 'bg-[#0E1E3D] text-white shadow-md'
